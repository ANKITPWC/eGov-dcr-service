	...
	public Plan process(Plan pl) {
		...
		if (DxfFileConstants.OC_RESIDENTIAL.equals(occupancyTypeHelper.getType().getCode())) {
			...
			if(DxfFileConstants.PLOTTED_DETACHED_OR_INDIVIDUAL_RESIDENTIAL_BUILDING.equals(occupancyTypeHelper.getSubtype().getCode())
					...
					pl.addError("wrng_oc","Found "+pl.getPlanInformation().getTotalNoOfDwellingUnits()+" Dwelling Units, More than 8 Dwelling Units not allowed in this sub-occupancy. Please change project  Sub-Occupancy to Apartment");
				}
